...
export const Hero = () => {
  return (
    <section className="min-h-[80vh] flex flex-col justify-center items-start text-left space-y-6 pt-24 pb-12 relative">
      <FadeIn delay={0.1}>
        <h1 className="text-4xl font-extrabold tracking-tight lg:text-5xl text-primary bg-clip-text text-transparent bg-gradient-to-r from-primary to-primary/60">
